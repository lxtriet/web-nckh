					...
					<ul class="nav nav-pills nav-stacked">
						...
						<div class="col-md-10">
							<div class="tab-content">
								<div class="tab-pane active" id="xemthongbao">
									<div class="row">
										...
										<div class="svThongBao " style="background:white;height:500px;margin-right:15px;border-radius:3px">
											...
											<div class="sv_table_thongbao" ng-app="sortApp" ng-controller="mainController">
												...
												<table class="table table-striped table-hover">
													...
													<tbody>
														<%
				     										for (TB_TK tbtk1: cttb.getListTB_TKByMaTK(session.getAttribute("Email").toString())) {
														%>
														<tr >
																<td><%=tbtk1.getTinTB() %></td>
																<td><%=tbtk1.getTenNguoiGui() %></td>
																<td><%=tbtk1.getNgayGui() %></td>
																<td><a href="sinvien_XemThongBao.jsp?MaCTTB=<%=tbtk1.getMaCTTB() %>">Xem</a></td>
																<td><a href="TB_TK_Servlet?command=delete&MaCTTB=<%=tbtk1.getMaCTTB() %>">Xóa</a></td>
															</tr>
															<%
			    											}
															%>
